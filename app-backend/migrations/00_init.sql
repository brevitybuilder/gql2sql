GRANT ALL PRIVILEGES ON SCHEMA public TO "user", "admin";
GRANT ALL PRIVILEGES ON SCHEMA auth TO "admin";

CREATE OR REPLACE FUNCTION nanoid(size int DEFAULT 21, alphabet text DEFAULT '346789ABCDEFGHJKLMNPQRTUVWXYabcdefghijkmnpqrtwxyz')
    RETURNS text
    LANGUAGE plpgsql
    volatile
AS
